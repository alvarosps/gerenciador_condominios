...
**Status**: **S34–S39 concluídas** (Fase 1 + Fase 2 BE + Fase 2 frontend data-layer). Próxima: **S40** (UI do calendário combinado + CRUD de contas + pagamento). Gate por fase mantido (≥90% standalone em `finances` no BE; vitest/tsc/eslint 0/0 no FE).
