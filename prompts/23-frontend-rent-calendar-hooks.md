...
4. **Regras do projeto** (precedência sobre qualquer convenção genérica):
   - `@.claude/rules/frontend.md`, `@.claude/rules/coding-standards.md`, `@.claude/rules/testing.md`, `@.claude/rules/design-principles.md`, `@.claude/rules/architecture.md`
