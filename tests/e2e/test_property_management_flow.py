...
class TestApartmentManagementFlow(BaseE2ETest):
    ...
    def test_complete_apartment_lifecycle(self):
        ...
        response = self.client.patch(f'/api/apartments/{apt_id}/', {
            'is_rented': True
        }, format='json')
        self.assert_response_success(response, 200)
    ...
    def test_multiple_apartments_in_building_flow(self):
        ...
        apartment_ids = []
        for i in range(1, 6):
            apt = self.create_apartment(
                building['id'],
                number=100 + i,
                rental_value=f"{1500 + i * 100}.00"
            )
...
class TestFurnitureManagementFlow(BaseE2ETest):
    ...
    def test_furniture_inventory_workflow(self):
        ...
        apartment = self.create_apartment(
            building['id'],
            number=201
        )
        ...
        tenant = self.create_tenant(
            name="João Silva",
            furniture_ids=[furniture_items[2]['id']]  # Table
        )
        ...
        response = self.client.patch(f'/api/furnitures/{furniture_id}/', {
...
class TestPropertySearchAndFilterFlow(BaseE2ETest):
    ...
    def test_comprehensive_search_workflow(self):
        ...
        apt2 = self.create_apartment(building1['id'], 102, rental_value="1500.00", is_rented=True)
        ...
        apt5 = self.create_apartment(building2['id'], 202, rental_value="2500.00", is_rented=True)
