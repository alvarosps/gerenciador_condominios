...
class TestGetContractTemplate:
    ...
    def test_get_template_unauthenticated(self, api_client):
        ...
        response = api_client.get("/api/templates/current/")
    ...
    def test_get_template_non_admin(self, api_client, db):
        ...
        user = User.objects.create_user(username="regular", password="regular123")
...
class TestSaveContractTemplate:
    """Test POST /api/templates/save/ endpoint."""
    ...
    def test_save_template_success(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/templates/save/", {"content": new_content}, format="json")
    ...
    def test_save_template_missing_content(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/templates/save/", {}, format="json")
    ...
    def test_save_template_empty_content(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/templates/save/", {"content": ""}, format="json")
    ...
    def test_save_template_unauthenticated(self, api_client):
        """Test that unauthenticated requests are rejected."""
        response = api_client.post("/api/templates/save/", {"content": "test"}, format="json")
...
class TestPreviewContractTemplate:
    ...
    def test_preview_template_success(self, authenticated_client, sample_lease):
        ...
        response = authenticated_client.post(
            ...
            {"content": template_content, "lease_id": sample_lease.id},
            format="json",
        )
    ...
    def test_preview_template_without_lease(self, authenticated_client, sample_lease):
        ...
        response = authenticated_client.post("/api/templates/preview/", {"content": template_content}, format="json")
    ...
    def test_preview_template_missing_content(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/templates/preview/", {}, format="json")
    ...
    def test_preview_template_invalid_lease(self, authenticated_client):
        ...
        response = authenticated_client.post(
            "/api/templates/preview/", {"content": "test", "lease_id": 99999}, format="json"
        )

        # Service returns 400 with descriptive error message for invalid lease
        assert response.status_code == status.HTTP_400_BAD_REQUEST
        assert "error" in response.data

    def test_preview_template_unauthenticated(self, api_client):
        """Test that unauthenticated requests are rejected."""
        response = api_client.post("/api/templates/preview/", {"content": "test"}, format="json")
...
class TestListTemplateBackups:
    """Test GET /api/templates/backups/ endpoint."""
    ...
    def test_list_backups_success(self, authenticated_client):
        ...
        authenticated_client.post(
            "/api/templates/save/", {"content": "<html><body>Backup Test</body></html>"}, format="json"
        )

        response = authenticated_client.get("/api/templates/backups/")
    ...
    def test_list_backups_unauthenticated(self, api_client):
        """Test that unauthenticated requests are rejected."""
        response = api_client.get("/api/templates/backups/")
...
class TestRestoreTemplateBackup:
    """Test POST /api/templates/restore/ endpoint."""
    ...
    def test_restore_backup_success(self, authenticated_client):
        ...
        save_response = authenticated_client.post("/api/templates/save/", {"content": original_content}, format="json")
        backup_filename = save_response.data["backup_filename"]

        # Change the template
        authenticated_client.post(
            "/api/templates/save/", {"content": "<html><body>Changed</body></html>"}, format="json"
        )

        # Restore from backup
        response = authenticated_client.post(
            "/api/templates/restore/", {"backup_filename": backup_filename}, format="json"
        )
    ...
    def test_restore_backup_missing_filename(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/templates/restore/", {}, format="json")
    ...
    def test_restore_backup_invalid_filename(self, authenticated_client):
        ...
        response = authenticated_client.post(
            "/api/templates/restore/", {"backup_filename": "nonexistent_backup.html"}, format="json"
        )
    ...
    def test_restore_backup_unauthenticated(self, api_client):
        """Test that unauthenticated requests are rejected."""
        response = api_client.post("/api/templates/restore/", {"backup_filename": "test.html"}, format="json")
...
class TestTemplateEndpointsIntegration:
    ...
    def test_complete_template_workflow(self, authenticated_client, sample_lease):
        ...
        get_response = authenticated_client.get("/api/templates/current/")
        assert get_response.status_code == status.HTTP_200_OK
        _original_content = get_response.data["content"]  # noqa: F841

        # 2. Save new template
        new_content = "<html><body>Workflow Test {{ tenant_name }}</body></html>"
        save_response = authenticated_client.post("/api/templates/save/", {"content": new_content}, format="json")
        ...
        preview_response = authenticated_client.post(
            "/api/templates/preview/",
            {"content": new_content, "lease_id": sample_lease.id},
            format="json",
        )
        ...
        # 4. List backups
        list_response = authenticated_client.get("/api/templates/backups/")
        ...
        verify_response = authenticated_client.get("/api/templates/current/")
