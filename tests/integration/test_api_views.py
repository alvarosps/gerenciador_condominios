...
class TestTenantAPI:
    ...
    def test_create_tenant_with_dependents(self):
        ...
        # Verify in database
        tenant = Tenant.objects.get(cpf_cnpj='987.654.321-00')
...
class TestLeaseAPI:
    ...
    def test_change_due_date(self):
        ...
        response = self.client.post(
            f'{self.url}{lease.id}/change_due_date/',
            data,
            format='json'
        )
