...
# T2: these tests build lease/adjustment dates relative to date.today() and assert against
# RentAdjustmentService, which reads today_sp() (Lote 8) — freezing the clock at noon (project
# convention, avoids UTC/SP-timezone day-boundary drift near midnight) makes both sources agree
# deterministically instead of depending on the real wall clock at test-run time.
FROZEN = "2026-07-12 12:00:00"
