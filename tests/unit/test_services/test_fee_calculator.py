...
class TestCalculateDailyRate:
    ...
    def test_calculate_daily_rate_higher_value(self):
        ...
        assert daily_rate == Decimal("200.00")  # 6000 / 30 = 200
...
class TestCalculateLateFee:
    ...
    def test_late_fee_not_late(self):
        ...
        result = FeeCalculatorService.calculate_late_fee(
            rental_value=Decimal("1500.00"), due_day=15, current_date=date(2025, 1, 10)
        )
    ...
    def test_late_fee_on_due_day(self):
        ...
        result = FeeCalculatorService.calculate_late_fee(
            rental_value=Decimal("1500.00"), due_day=15, current_date=date(2025, 1, 15)
        )
    ...
    def test_late_fee_one_day_late(self):
        ...
        result = FeeCalculatorService.calculate_late_fee(
            rental_value=Decimal("1500.00"), due_day=10, current_date=date(2025, 1, 11)
        )
    ...
    def test_late_fee_multiple_days(self):
        ...
        result = FeeCalculatorService.calculate_late_fee(
            rental_value=Decimal("1500.00"), due_day=5, current_date=date(2025, 1, 15)
        )
    ...
    def test_late_fee_end_of_month(self):
        ...
        result = FeeCalculatorService.calculate_late_fee(
            rental_value=Decimal("6000.00"), due_day=1, current_date=date(2025, 1, 31)
        )

        # 30 days late
        # daily_rate = 6000 / 30 = 200.00
        # late_fee = 200.00 * 30 * 0.05 = 300.00
        assert result["is_late"] is True
        assert result["late_days"] == 30
        assert result["late_fee"] == Decimal("300.00")
...
class TestCalculateDueDateChangeFee:
    ...
    def test_due_date_change_fee_forward(self):
        ...
        result = FeeCalculatorService.calculate_due_date_change_fee(
            rental_value=Decimal("1500.00"), current_due_day=10, new_due_day=15
        )
    ...
    def test_due_date_change_fee_backward(self):
        ...
        result = FeeCalculatorService.calculate_due_date_change_fee(
            rental_value=Decimal("1500.00"), current_due_day=20, new_due_day=10
        )
    ...
    def test_due_date_change_fee_no_change(self):
        ...
        result = FeeCalculatorService.calculate_due_date_change_fee(
            rental_value=Decimal("1500.00"), current_due_day=15, new_due_day=15
        )
    ...
    def test_due_date_change_fee_large_difference(self):
        ...
        result = FeeCalculatorService.calculate_due_date_change_fee(
            rental_value=Decimal("2000.00"), current_due_day=5, new_due_day=25
        )
...
class TestCalculateTotalValue:
    ...
    def test_total_value_standard(self):
        ...
        total = FeeCalculatorService.calculate_total_value(
            rental_value=Decimal("1500.00"), cleaning_fee=Decimal("200.00"), tag_fee=Decimal("50.00")
        )
    ...
    def test_total_value_with_multiple_tenant_tag(self):
        ...
        total = FeeCalculatorService.calculate_total_value(
            rental_value=Decimal("1500.00"), cleaning_fee=Decimal("200.00"), tag_fee=Decimal("80.00")
        )
    ...
    def test_total_value_no_cleaning_fee(self):
        ...
        total = FeeCalculatorService.calculate_total_value(
            rental_value=Decimal("1500.00"), cleaning_fee=Decimal("0.00"), tag_fee=Decimal("50.00")
        )
    ...
    def test_total_value_high_values(self):
        ...
        total = FeeCalculatorService.calculate_total_value(
            rental_value=Decimal("5000.00"), cleaning_fee=Decimal("500.00"), tag_fee=Decimal("80.00")
        )
    ...
    def test_total_value_decimal_precision(self):
        ...
        total = FeeCalculatorService.calculate_total_value(
            rental_value=Decimal("1550.50"), cleaning_fee=Decimal("225.75"), tag_fee=Decimal("80.00")
        )
...
class TestFeeCalculatorServiceIntegration:
    ...
    def test_complete_lease_fee_scenario(self):
        ...
        total = FeeCalculatorService.calculate_total_value(
            rental_value=rental_value, cleaning_fee=Decimal("200.00"), tag_fee=tag_fee
        )
        assert total == Decimal("1780.00")

        # Calculate late fee (10 days late)
        late_result = FeeCalculatorService.calculate_late_fee(
            rental_value=rental_value, due_day=5, current_date=date(2025, 1, 15)
        )
        ...
        change_result = FeeCalculatorService.calculate_due_date_change_fee(
            rental_value=rental_value, current_due_day=5, new_due_day=10
        )
    ...
    def test_edge_case_very_low_rental(self):
        ...
        late_result = FeeCalculatorService.calculate_late_fee(
            rental_value=rental_value, due_day=1, current_date=date(2025, 1, 15)
        )
