...
from core.models import Building, Apartment, Tenant, Lease, Dependent, Furniture
...
def sample_buildings():
    ...
    building1 = Building.objects.create(
        street_number=836,
        name="Building A",
        address="Street A, 836"
    )
    building2 = Building.objects.create(
        street_number=850,
        name="Building B",
        address="Street B, 850"
    )
...
def sample_dependents(sample_tenants):
    ...
    dep1 = Dependent.objects.create(
        tenant=sample_tenants[0],
        name="John Doe Jr",
        phone="11977777777"
    )
    dep2 = Dependent.objects.create(
        tenant=sample_tenants[0],
        name="Jane Doe",
        phone="11966666666"
    )
...
class TestGetBuildingStatistics:
    ...
    def test_building_statistics_multiple_buildings(self, sample_leases):
        ...
        # Total revenue: 1500 + 1500 = 6000
        assert building_836['total_revenue'] == Decimal('6000.00')
...
class TestGetTenantStatistics:
    ...
    def test_tenant_statistics_standard(self, sample_tenants, sample_dependents):
        ...
        assert 'Married' in stats['marital_status_distribution']
        assert 'Single' in stats['marital_status_distribution']
        assert stats['marital_status_distribution']['Married'] == 1
        assert stats['marital_status_distribution']['Single'] == 1
    ...
    def test_tenant_statistics_marital_status_variety(self, sample_tenants):
        ...
        # sample_tenants has: "Married", "Single", "Solteiro(a)"
