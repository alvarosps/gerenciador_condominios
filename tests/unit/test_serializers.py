...
class TestBuildingSerializer:
    ...
    def test_deserialize_building(self):
        ...
        data = {
            'street_number': 850,
            'name': 'Edifício Novo',
            'address': 'Rua Nova, 850 - São Paulo/SP'
        }
...
class TestTenantSerializer:
    ...
    def test_update_tenant_dependents(self):
        ...
        tenant = TenantFactory()
        old_dep = DependentFactory(tenant=tenant, name="Filho Antigo")
        ...
        data = {
            ...
            'dependents': [
                {'name': 'Novo Filho', 'phone': '(11) 93333-3333'}
            ]
        }
