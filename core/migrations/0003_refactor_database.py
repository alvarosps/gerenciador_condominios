    ...
    for lease in Lease.objects.all():
        ...
        for tenant in lease.tenants.all():
            if tenant != lease.responsible_tenant:
                LeaseTenant.objects.create(
                    lease=lease, tenant=tenant, is_responsible=False, move_in_date=lease.start_date
                )
...
def create_initial_payments(apps, schema_editor):
    ...
    for lease in Lease.objects.all():
        ...
        if not Payment.objects.filter(
            lease=lease, reference_month=current_month_start, payment_category="rent"
        ).exists():
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("condominium_fee", models.DecimalField(decimal_places=2, default=Decimal("0.00"), max_digits=10)),
                ("iptu_value", models.DecimalField(decimal_places=2, default=Decimal("0.00"), max_digits=10)),
                ...
                (
                    "apartment",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="pricing_history", to="core.apartment"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lease",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="payments", to="core.lease"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("tag_deposit_amount", models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
